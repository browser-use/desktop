...
- [iter 15 | 14:36Z] perf spec landed (startup.spec.ts, 5-launch, N=0 runs collected — build exists, live run deferred out of budget); PERFORMANCE.md estimates replaced with honest no-data rows (2 commits c00da9a, af925cd)
